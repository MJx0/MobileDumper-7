...
// Embedded verbatim from Scripts/IDAMappingImporter.py and
// Scripts/GhidraMappingImporter.py at the repository root. Written out
// alongside every generated .idmap file (IDAMappingGenerator::Generate())
// so a dump is immediately usable without hunting down the importer
// scripts separately. Keep this in sync with those two files by hand
// when they change -- there is no build step that embeds them automatically.

namespace IDAMappingScripts
{
	inline constexpr const char* IDAMappingImporterPy = R"MD7_PYSRC(
"""
...
if __name__ == "__main__":
	...
	inline constexpr const char* GhidraMappingImporterPy = R"MD7_PYSRC(
# -*- coding: utf-8 -*-
"""
